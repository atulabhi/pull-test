...
var outhtmlstart = '';
var outhtmlissue = '';
var outhtmltotalstart = '';
$('#ghapidata').html('<div id="loader"><img src="css/loader.gif" alt="loading..."></div>');
var repositories1;
var repo = 'https://api.github.com/repos/openebs/openebs?client_id=db5e3e3ede4e4174e0d6&client_secret=fdaad534cddc7373daf361a4d9d447ecdfb125ed'
...
function allcontibutor() {
    ...
    $.getJSON(repo, function(json) {
        ...
        console.log(Math.round(repodetails.stargazers_count / 1000, 2));
        x = repodetails.stargazers_count / 1000;
        var with2Decimals = x.toString().match(/^-?\d+(?:\.\d{0,1})?/)[0]
        console.log(with2Decimals);
        console.log(repodetails.open_issues_count);
        // document.getElementById("star-count").value = with2Decimals
        // document.getElementById("issue-count").value = repodetails.open_issues_count
        $('#star-count').html(outhtmlstart + with2Decimals);
        $('#issue-count').html(outhtmlissue + repodetails.open_issues_count);
        $('#total').html(outhtmltotalstart + repodetails.stargazers_count);
...
function initMap() {
    ...
    var all = [{ lat: 12.9715987, lng: 77.5945627 }, { lat: 12.9715987, lng: 77.5945627 }, { lat: 12.9715987, lng: 77.5945627 }, { lat: 12.9715987, lng: 77.5945627 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 12.9715987, lng: 77.5945627 }, { lat: 12.9715987, lng: 77.5945627 }, { lat: 12.9715987, lng: 77.5945627 }, { lat: 12.9715987, lng: 77.5945627 }, { lat: 12.9715987, lng: 77.5945627 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 12.9715987, lng: 77.5945627 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 37.4418834, lng: -122.1430195 }, { lat: 26.449923, lng: 80.3318736 }, { lat: 23.3440997, lng: 85.309562 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 20.593684, lng: 78.96288 }, { lat: 19.0759837, lng: 72.8776559 }, { lat: 49.2827291, lng: -123.1207375 }, { lat: 28.6139391, lng: 77.2090212 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 12.9715987, lng: 77.5945627 }, { lat: 51.165691, lng: 10.451526 }, { lat: 15.783471, lng: -90.23075899999999 }, { lat: 17.385044, lng: 78.486671 }, { lat: 51.48158100000001, lng: -3.17909 }, { lat: 55.378051, lng: -3.435973 }, { lat: 43.4642578, lng: -80.5204096 }, { lat: 32.715738, lng: -117.1610838 }, { lat: 20.593684, lng: 78.96288 }, { lat: 23.181467, lng: 79.9864071 }, { lat: 62.4113634, lng: -149.0729714 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 19.2094006, lng: 73.0939483 }, { lat: 37.09024, lng: -95.712891 }, { lat: 43.653226, lng: -79.3831843 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 11.2194391, lng: 78.1677236 }, { lat: 12.9715987, lng: 77.5945627 }, { lat: -33.8688197, lng: 151.2092955 }, { lat: 13.0826802, lng: 80.2707184 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 37.7749295, lng: -122.4194155 }, { lat: 12.9715987, lng: 77.5945627 }, { lat: 37.3229978, lng: -122.0321823 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 12.9715987, lng: 77.5945627 }, { lat: 37.4418834, lng: -122.1430195 }, { lat: 40.7127753, lng: -74.0059728 }, { lat: 32.7766642, lng: -96.79698789999999 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 21.4668716, lng: 83.9811665 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 40.46366700000001, lng: -3.74922 }, { lat: 46.227638, lng: 2.213749 }, { lat: 12.9715987, lng: 77.5945627 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 28.6139391, lng: 77.2090212 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 20.593684, lng: 78.96288 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 20.593684, lng: 78.96288 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 42.3237073, lng: -83.8783543 }, { lat: 43.4642578, lng: -80.5204096 }, { lat: 28.7040592, lng: 77.10249019999999 }, { lat: 22.3038945, lng: 70.80215989999999 }, { lat: -37.68779749999999, lng: 176.1651295 }, { lat: 41.8781136, lng: -87.6297982 }, { lat: 22.572646, lng: 88.36389500000001 }, { lat: 37.09024, lng: -95.712891 }, { lat: 12.9715987, lng: 77.5945627 }, { lat: 51.3396955, lng: 12.3730747 }, { lat: 46.2043907, lng: 6.1431577 }, { lat: 24.585445, lng: 73.712479 }, { lat: 45.5230622, lng: -122.6764815 }];
    var mzoom;
